...
export const metadata: Metadata = {
    ...
    description: 'Toon Blast is committed to digital accessibility. Learn about our efforts to make our game available to everyone.',
    keywords: ['Toon Blast accessibility', 'accessible game', 'web accessibility statement'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Our commitment to making Toon Blast accessible to everyone.</p>
                </div>
            </div>

            <div className="page-content">
                <p>
                    Toon Blast is committed to ensuring digital accessibility for people with disabilities.
                ...
                <p>
                    We recognize that the game component of Toon Blast presents additional accessibility
                ...
                <h2>Feedback</h2>
                <p>
                    We welcome your feedback on the accessibility of Toon Blast. If you encounter
                ...
                <ul>
                    ...
                    <li>Email: <strong>accessibility@toonblast.xyz</strong></li>
                </ul>
                <p>
