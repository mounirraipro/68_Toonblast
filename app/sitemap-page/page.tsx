...
export const metadata: Metadata = {
    ...
    description: 'Browse the complete sitemap of Toon Blast. Find every page on our website including games, blog posts, and information pages.',
    keywords: ['Toon Blast sitemap', 'all pages', 'site navigation'],
    alternates: {
...
const sections = [
    {
        ...
        links: [
            { href: '/', label: 'Home' },
            { href: '/play', label: 'Play Toon Blast' },
    ...
    },
    {
        ...
        links: [
            ...
            { href: '/blog/what-is-jigsolitaire', label: 'What is Toon Blast?' },
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Browse every page on Toon Blast.</p>
                </div>
            </div>
