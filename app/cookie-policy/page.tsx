...
export const metadata: Metadata = {
    title: 'Cookie Policy',
    description: 'Learn about the cookies Toon Blast uses, why we use them, and how to manage your cookie preferences.',
    keywords: ['Toon Blast cookies', 'cookie policy', 'cookie preferences', 'tracking cookies'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    This Cookie Policy explains what cookies are, how Toon Blast uses them, and how you can
                ...
                <p>Toon Blast uses cookies for the following purposes:</p>
                ...
                <p>
                    We currently do not use any tracking or analytics cookies (such as Google Analytics) on Toon Blast.
                </p>
                ...
                <p>
                    ...
                    or email <strong>privacy@toonblast.xyz</strong>.
                </p>
            </div>
        </>
    );
