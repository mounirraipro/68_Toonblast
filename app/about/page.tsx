...
const aboutSchema = [
    {
        ...
        '@type': 'AboutPage',
        name: 'About Toon Blast',
        url: 'https://toonblast.xyz/about',
        description: 'Learn about Toon Blast, our mission, and the team behind the game.',
        publisher: {
            '@type': 'Organization',
            name: 'Toon Blast',
...
export const metadata: Metadata = {
    title: 'About Us – Toon Blast',
    description: 'Learn about Toon Blast, our mission, and the team behind the game.',
    keywords: ['about Toon Blast', 'game team', 'who made Toon Blast'],
};
        ...
        <>
            ...
            <div className="page-header">
                <div className="container">
                    <h1 className="gradient-text">About Toon Blast</h1>
            ...
            <div className="page-content">
                <h2>Our Story</h2>
                <p>
                    Toon Blast was born from a simple idea: what if playing Toon Blast could be even simpler and more accessible?. The result is a game
                    that&apos;s instantly intuitive yet endlessly engaging — an experience unlike any other on the web.
                </p>
                <p>
                    We launched Toon Blast with a clear vision — to create a free, accessible, and
                    ...
                    Toon Blast has something for you.
                </p>
                ...
                <p>
                    Every level in Toon Blast is handcrafted with care. We obsess over the details
                    so you can simply enjoy the game.
                </p>

                <h2>What Makes Us Different</h2>
                <p>
                    Toon Blast offers a unique experience compared to similar games in its category.
                </p>
                ...
                <p>
                    ...
                    <a href="/contact">Contact page</a>. Your input helps us make Toon Blast better for
                    everyone.
                </p>
            </div>
        </>
