...
const SUPPORT_EMAIL = 'hello@toonblast.xyz';

export const metadata: Metadata = {
    title: 'Contact Toon Blast',
    description: 'Get in touch with the Toon Blast team for support, feedback, partnerships, accessibility concerns, or privacy questions.',
    keywords: ['contact Toon Blast', 'Toon Blast support', 'game contact'],
    alternates: {
        canonical: '/contact',
    },
};
