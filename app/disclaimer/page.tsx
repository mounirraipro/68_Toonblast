...
export const metadata: Metadata = {
    title: 'Disclaimer',
    description: 'Read the Toon Blast disclaimer regarding website content accuracy, external links, and general use of our free online game.',
    keywords: ['Toon Blast disclaimer', 'website disclaimer', 'legal disclaimer'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    The information provided by Toon Blast (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) on toonblast.xyz
                ...
                <p>
                    Toon Blast is a browser-based entertainment product provided free of charge. The game
                ...
                <p>
                    Toon Blast displays third-party advertisements (including Google AdSense ads) to
                    ...
                    an endorsement or recommendation by Toon Blast.
                </p>
                ...
                <p>
                    ...
                    has been obtained from reliable sources, Toon Blast is not responsible for any errors
